...
FORCE_PIC = os.environ.get("FORCE_PIC", "https://i.ibb.co/VpJ3QzB9/tmpq8aejh5b.jpg") 
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5748581347 7165179639 5150045729").split()):
        ADMINS.append(int(x))
except ValueError:
